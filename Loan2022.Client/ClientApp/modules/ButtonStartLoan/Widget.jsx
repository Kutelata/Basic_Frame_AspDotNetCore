...
const Widget = (props)=>{
   const [loading, setLoading] = useState(false)
    ...
    return (<>
        <Modal onCancel={()=>{setModalVerified(false)}} className="modal-verified" visible={modalVerified} title="Thông báo" footer={[<Button key="1" type="primary" onClick={()=>{
            window.location.href="/verify"
        }} style={{textAlign:"center"}}>Xác minh ngay</Button>]}>
            <h4>Bạn chưa xác minh hãy tiến hành xác minh</h4>
        </Modal>
        
        <Modal onCancel={()=>{setModalFalse(false)}} className="modal-verified flex-scc" visible={modalFalse} title="Thông báo"  footer={[<Button onClick={()=>{
            setModalFalse(false)
        }}>Đóng</Button>,<Button key="1" type="primary" onClick={()=>{
                window.location.href="/verify"
            }} style={{textAlign:"center", textTransform:"uppercase"}} onClick={()=>{
                if(globalData.employee){
                    location.href = globalData.employee;
                }else {
                    setModalFalse(false)
                }
               
        }}>Liên hệ thẩm định viên</Button>]}>
            <div>Bạn đang có khoản vay chưa hoàn thành</div>
            <div>Bạn không thể đăng ký hồ sơ mới</div>
            <div>Vui lòng ấn vào LIÊN HỆ THẨM ĐỊNH VIÊN tư vấn và hỗ trợ</div>
        </Modal>
      <Spin spinning={loading}>
          <button className="button" onClick={loan}>
              ...
              <svg className="button__svg" role="presentational" viewBox="0 0 600 600">
                  ...
                  <g clipPath="url(#myClip)">
                      <g id="money">
                          <path
                              ...
                              fill="#699e64" stroke="#323c44" strokeMiterlimit="10" strokeWidth="14"/>
                          <path
                      ...
                      <g id="creditcard">
                          <path
                              ...
                              fill="#a76fe2" stroke="#323c44" strokeMiterlimit="10" strokeWidth="14"/>
                          <path
                  ...
                  <g id="wallet">
                      <path
                          ...
                          fill="#a4bdc1" stroke="#323c44" strokeMiterlimit="10" strokeWidth="14"/>
                      <path
                      ...
                      <path d="M451.46,435.79v7.88a14.48,14.48,0,1,1-29,0v-7.9a14.48,14.48,0,0,1,29,0Z" fill="#a4bdc1"
                            stroke="#323c44" strokeMiterlimit="10" strokeWidth="14"/>
                      <path
